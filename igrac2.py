...
class Igrac2:
    ...
    def draw(self):
        pygame.draw.circle(self.app.screen,IGRAC_BOJA2,(int(self.pix_pos.x),int(self.pix_pos.y)),self.app.cell_width-12)
        for x in range(self.lives):
            pygame.draw.circle(self.app.screen,IGRAC_BOJA2,(545 + 20*x,HEIGHT - 15),7)
