...
from PRojekat.venv.podesavanja import IGRAC_BOJA, HEIGHT
...
class Igrac:
    ...
    def draw(self):
        pygame.draw.circle(self.app.screen,IGRAC_BOJA,(int(self.pix_pos.x),int(self.pix_pos.y)),self.app.cell_width-12)
        for x in range(self.lives):
            pygame.draw.circle(self.app.screen,IGRAC_BOJA,(WIDTH//2-115 + 20*x,HEIGHT - 15),7)

        #crtanje kvadrata u grid
